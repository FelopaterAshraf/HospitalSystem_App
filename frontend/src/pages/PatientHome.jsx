                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-3 mb-10">
                            <Link to="/appointments/book">
                                <button className="bg-brand-primary hover:bg-green-600 text-white px-6 py-3 rounded-xl font-semibold flex items-center gap-2 transition-all shadow-lg shadow-brand-primary/30 hover:shadow-brand-primary/50 hover:-translate-y-0.5">
                                    <CalendarPlus size={18} /> Book Appointment
                                </button>
                            </Link>
                            <Link to="/my-appointments">
                                <button className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-6 py-3 rounded-xl font-semibold flex items-center gap-2 transition-all hover:-translate-y-0.5">
                                    <ClipboardList size={18} /> My Appointments
                                </button>
                            </Link>
                        </div>
            ...
            <div className="animate-slide-up" style={{ animationDelay: '0.1s' }}>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {services.map(({ icon: Icon, label, desc, gradient }) => (
                        ...
                        >
                            <div className={`bg-gradient-to-br ${gradient} p-3.5 rounded-xl shadow-sm group-hover:scale-110 transition-transform duration-200`}>
            ...
            <div className="animate-slide-up" style={{ animationDelay: '0.3s' }}>
                ...
                {loadingAppts ? (
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 text-center">
                        ...
                        <Link to="/appointments/book">
                            <button className="bg-brand-primary text-white px-6 py-2.5 rounded-xl font-medium hover:bg-brand-dark transition-colors shadow-sm">
                                Book an Appointment
                            </button>
                        </Link>
                    </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-gray-50/80 border-b border-gray-100 text-gray-500 text-sm">
                                    <th className="px-6 py-3.5 font-medium">Doctor</th>
