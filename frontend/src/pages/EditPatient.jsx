        ...
        <div className="animate-fade-in max-w-2xl mx-auto mt-10">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    <div>
                        <label htmlFor="edit-pat-name" className="block text-sm font-semibold text-gray-700 mb-2">Patient's Full Name</label>
                        <input
                            id="edit-pat-name"
                            type="text"
                            value={name}
                    ...
                    <div>
                        <label htmlFor="edit-pat-diagnosis" className="block text-sm font-semibold text-gray-700 mb-2">Current Diagnosis</label>
                        <input
                            id="edit-pat-diagnosis"
                            type="text"
                            value={diagnosis}
